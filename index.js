...
input.addEventListener("keydown", (dets)=>{
    ...
    //     if(dets.key === "Backspace"){
        ...
        //     }
        // }
        if(dets.key !== "AltGraph" && dets.key !== "Control" && dets.key !== "Shift" && dets.key !== "Enter" && dets.key !== "Tab" && dets.key !== "Alt" && dets.key !== "CapsLock" && dets.key !== "ArrowLeft" && dets.key !== "ArrowRight" && dets.key !== "ArrowUp" && dets.key !== "ArrowDown"){
